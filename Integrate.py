...
def eulerStep(c, inputs, i, dt):
	n.setInput(inputs[i])
	return T.cast(c + dt*n.output, "float32")

class Integrate(object):
	def __init__(self, inputs, outputs, i, c0, dt=0.01):
